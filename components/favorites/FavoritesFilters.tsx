    ...
    <div className="rounded-3xl border border-white/10 bg-[#0B1220] p-6 shadow-xl">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* Filter */}
          <button className="flex items-center gap-2 rounded-2xl border border-white/10 bg-[#050814] px-5 py-3 text-sm text-white transition hover:border-blue-500 hover:bg-blue-500/10">
