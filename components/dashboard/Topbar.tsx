...
const tools = [
  {
    ...
    description: "Generate engaging YouTube titles with AI.",
  ...
  },
  {
    ...
    description: "Find relevant hashtags for your content.",
  ...
  {
    name: "Script Writer",
    description: "Write engaging YouTube scripts with AI.",
    path: "/dashboard/tools/script-writer",
  },
  {
    name: "Shorts Ideas",
    description: "Get creative YouTube Shorts ideas.",
    path: "/dashboard/tools/shorts-ideas",
  },
  {
    name: "Thumbnail Title",
    description: "Generate powerful thumbnail titles.",
    path: "/dashboard/tools/thumbnail-title",
  },
  {
    name: "SEO Checker",
    description: "Check and improve your YouTube SEO.",
    path: "/dashboard/tools/seo-checker",
  },
  {
    name: "Keyword Generator",
    description: "Discover useful keywords for your videos.",
    path: "/dashboard/tools/keyword-generator",
  },
  {
    name: "Best Upload Time",
    description: "Find the best time to publish your videos.",
...
const notifications = [
  ...
  },
  {
    ...
    message: "Check the RYNOVIX roadmap for upcoming tools.",
    time: "Recently",
  },
];
  ...
  return (
    <header className="sticky top-0 z-30 flex h-20 items-center justify-between border-b border-white/10 bg-[#050814]/80 px-8 backdrop-blur-md">
      {/* Left */}
      <div>
  ...
  className="w-72 rounded-xl border border-white/10 bg-[#0B1220] py-3 pl-11 pr-4 text-sm text-white placeholder:text-gray-500 outline-none transition-all focus:border-blue-500"
/>
{searchQuery.trim() !== "" && (
  ...
  <button
    ...
    className="relative rounded-xl border border-white/10 bg-[#0B1220] p-3 text-gray-300 transition hover:border-blue-500 hover:text-white"
  >
    <Bell size={20} />
  ...
  {notificationOpen && (
    <div className="absolute right-0 top-full mt-3 w-80 overflow-hidden rounded-2xl border border-white/10 bg-[#0B1220] shadow-2xl shadow-black/40">
      {/* Header */}
      ...
      <div className="border-t border-white/10 p-2">
        ...
        <div ref={menuRef} className="relative">
          <button
            ...
            className="flex items-center gap-3 rounded-xl border border-white/10 bg-[#0B1220] px-4 py-2 transition hover:border-blue-500"
          >
            {/* Avatar */}
          ...
          {/* Dropdown */}
          {menuOpen && (
            <div className="absolute right-0 top-full mt-3 w-72 overflow-hidden rounded-2xl border border-white/10 bg-[#0B1220] shadow-2xl shadow-black/40">
              {/* Profile Header */}
